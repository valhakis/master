...
Text::Text(Shader &shader) {
  ...
  // Load font as face
  FT_Face face;
  if (FT_New_Face(ft, "/home/viktor/master/game/data/fonts/arial.ttf", 0, &face))
  ...
  glUniformMatrix4fv(glGetUniformLocation(this->shader->GetProgram(), "projection"), 1, GL_FALSE, glm::value_ptr(projection));
}
